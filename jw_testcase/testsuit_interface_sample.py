...
if __name__ == '__main__':
    ...
    #     print " the row[2] is############ ->",strtestname,row[5]
    #     resultone=connection_db.selectIFD_EXPASSERTOneonly(row[3])
    #     strassertname=resultone[3]
    #     print " the resultone[3] is############ ->",strassertname
    #     connection_db.httpGetImplement(strtestname,strassertname,row[5]);
    ...
    for row in result:
        ...
        if "get" in strtesttype:
            if strassertname != "e":
                generateutils.httpGetImplement(strtestname,strassertname,row[5],"open09.edaixi.cn1111111");
            else:
                print "the aassert is none value..."
        else:
            if strassertname != "e":
                generateutils.httpPostImplement("testpost","/client/v1/get_order?user_id=11452&order_id=12173793044055");
            else:
                print "the aassert is none value..."
        ...
        # else :
        #     generateutils.httpGetImplement(resultone[0],resultone[3]);
    # resultassert=connection_db.selectIFD_EXPASSERTOneRecord()
